...
pub fn disassemble(bytecode: &[u8]) {
    ...
    while reader.head < reader.bytes.len() {
        ...
        match op {
            ...
            Instr::SubInt => println!("SUB_INT"),
            Instr::MulInt => println!("MUL_INT"),
            Instr::DivInt => println!("DIV_INT"),
            Instr::Neg => println!("NEG"),
            Instr::CreateMap { num_keys } => println!("CREATE_MAP {num_keys}"),
            Instr::CreateArray { size } => println!("CREATE_ARRAY {size}"),
            ...
            Instr::ArrayIndex => println!("ARRAY_INDEX"),
            Instr::StringIndex => println!("STRING_INDEX"),
            Instr::StringSliceRange => println!("STRING_SLICE_RANGE"),
